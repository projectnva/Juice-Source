   ...
   public void func_177439_a(byte[] p_177439_1_, int p_177439_2_, boolean p_177439_3_) {
      ...
      for(int l = 0; l < this.field_76652_q.length; ++l) {
         if((p_177439_2_ & 1 << l) != 0 && this.field_76652_q[l] != null) {
            ...
            System.arraycopy((Object)p_177439_1_, i, (Object)nibblearray.func_177481_a(), 0, nibblearray.func_177481_a().length);
      ...
      if(flag) {
         for(int i1 = 0; i1 < this.field_76652_q.length; ++i1) {
            if((p_177439_2_ & 1 << i1) != 0 && this.field_76652_q[i1] != null) {
               ...
               System.arraycopy((Object)p_177439_1_, i, (Object)nibblearray1.func_177481_a(), 0, nibblearray1.func_177481_a().length);
      ...
      if(p_177439_3_) {
         System.arraycopy((Object)p_177439_1_, i, (Object)this.field_76651_r, 0, this.field_76651_r.length);
