...
public class TextureUtil {
   ...
   private static void func_147947_a(int p_147947_0_, int[] p_147947_1_, int p_147947_2_, int p_147947_3_, int p_147947_4_, int p_147947_5_, boolean p_147947_6_, boolean p_147947_7_, boolean p_147947_8_) {
      ...
      for(int j = 0; j < p_147947_2_ * p_147947_3_; j += p_147947_2_ * l) {
         ...
         GL11.glTexSubImage2D(3553, p_147947_0_, p_147947_4_, p_147947_5_ + k, p_147947_2_, l, '\u80e1', '\u8367', (IntBuffer)field_111000_c);
      }
   ...
   public static void func_180600_a(int p_180600_0_, int p_180600_1_, int p_180600_2_, int p_180600_3_) {
      ...
      for(int i = 0; i <= p_180600_1_; ++i) {
         GL11.glTexImage2D(3553, i, 6408, p_180600_2_ >> i, p_180600_3_ >> i, 0, '\u80e1', '\u8367', (IntBuffer)((IntBuffer)null));
      }
   ...
   private static void func_110993_a(BufferedImage p_110993_0_, int p_110993_1_, int p_110993_2_, boolean p_110993_3_, boolean p_110993_4_) {
      ...
      for(int l = 0; l < i * j; l += i * k) {
         ...
         GL11.glTexSubImage2D(3553, 0, p_110993_1_, p_110993_2_ + i1, i, j1, '\u80e1', '\u8367', (IntBuffer)field_111000_c);
      }
   ...
   public static void func_147953_a(int[] p_147953_0_, int p_147953_1_, int p_147953_2_) {
      ...
      for(int j = 0; j < i; ++j) {
         System.arraycopy((Object)p_147953_0_, j * p_147953_1_, (Object)aint, 0, p_147953_1_);
         System.arraycopy((Object)p_147953_0_, (p_147953_2_ - 1 - j) * p_147953_1_, (Object)p_147953_0_, j * p_147953_1_, p_147953_1_);
         System.arraycopy((Object)aint, 0, (Object)p_147953_0_, (p_147953_2_ - 1 - j) * p_147953_1_, p_147953_1_);
      }
   ...
   static {
      ...
      for(int l = 0; l < 16; ++l) {
         System.arraycopy((Object)(l < k?aint:aint1), 0, (Object)field_110999_b, 16 * l, k);
         System.arraycopy((Object)(l < k?aint1:aint), 0, (Object)field_110999_b, 16 * l + k, k);
      }
