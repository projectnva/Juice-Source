...
import YourClientName.mods.ModInstances;
...
public class YourClientNameMovementInput extends MovementInput {
	...
	public YourClientNameMovementInput(GameSettings gameSettings) {
