...
void main() {
	...
	vec3 finalComposite = final.sunlight 			* 0.55f 	* sunlightMult				//Add direct sunlight
						...
						+ final.nolight 			* 0.007f 			//Add base ambient light
						...
						+ final.torchlight 			* 7.0f 			//Add light coming from emissive blocks
						+ final.glow.lava			* 13.0f 			
						+ final.glow.glowstone		* 5.0f 			
						+ final.glow.fire			* 1.025f 			
						+ final.glow.torch			* 7.0f 	
						+ final.heldLight 			* 0.5f		
						;
