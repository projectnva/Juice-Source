...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
        ...
        {
        	this.splashText = "Juice Client is dead!";
        }
    ...
    private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_)
    {
        ...
        this.buttonList.add(new GuiButton(3, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, I18n.format("Juice Client", new Object[0])));
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
		...
		String s = "Juice Client V" + Client.version;
        ...
        this.drawString(this.fontRendererObj, s, 2, this.height - 10, 0x00800080);
        String s1 = ".gg/XcbsgjkBsH";
