...
public class GuiCode extends GuiScreen {
	
	private int field_146445_a;
    private int field_146444_f;
	private GuiIngameMenu GuiIngameMenu;
	
	public GuiCode(GuiIngameMenu guiIngameMenu) {
	...
	public void initGui() {
        ...
        this.buttonList.add(new GuiButton(4, this.width / 2 - 100, this.height / 4 + 48 + i, I18n.format("Cape Select", new Object[0])));
	...
	protected void actionPerformed(GuiButton button) throws IOException {
		switch (button.id)
        {
            ...
            case 301:
                ...
                break;
            case 4:
            	this.mc.displayGuiScreen(new GuiCapeMenu());
