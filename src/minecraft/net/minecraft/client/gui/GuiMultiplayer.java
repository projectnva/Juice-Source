...
import clientname.ServerDataFeatured;
...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
    	Client.getInstance().getDiscordRP().update("Idle", "Multiplayer Meun");
    ...
    {
    	this.buttonList.add(new GuiButton(34, this.width / 2 - 255, this.height - 503, 70, 20, I18n.format("ReAuth", new Object[0])));
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        if (button.enabled)
        {
            ...
            {
            	this.mc.displayGuiScreen(new GuiLogin(null));
            }
        }
    }
