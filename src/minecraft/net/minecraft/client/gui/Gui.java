...
public class Gui
{
    ...
    public static final ResourceLocation betterBackgroud = new ResourceLocation("clientname/download.png");
     ...
     * @param k 
     */
    public static void drawRect(double left, double top, double right, double bottom, int k)
    {
        if (left < right)
        {
            double i = left;
