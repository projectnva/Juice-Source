...
public class GuiPlayerTabOverlay extends Gui
{
    ...
    public void renderPlayerlist(int width, Scoreboard scoreboardIn, ScoreObjective scoreObjectiveIn)
    {
        ...
        for (int k4 = 0; k4 < l3; ++k4)
        {
            ...
            if (k4 < list.size())
            {
                ...
                this.drawPing(null, i1, j2 - (flag ? 9 : 0), k2, networkplayerinfo1);
            }
        }
    ...
    private static final ResourceLocation Juice = new ResourceLocation("clientname/juiceping.png");
    
    protected void drawPing(AbstractClientPlayer player, int p_175245_1_, int p_175245_2_, int p_175245_3_, NetworkPlayerInfo networkPlayerInfoIn)
    {
        GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
		...
		//if(HTTPFunctions.isJuiceClient()) {
        //    Minecraft.getMinecraft().getTextureManager().bindTexture(Juice);
