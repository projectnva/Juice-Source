...
public class LoadingScreenRenderer implements IProgressUpdate
{
    ...
    {
        this.mc = mcIn;
        this.scaledResolution = new ScaledResolution(mcIn, 0, 0);
    ...
    private void displayString(String message)
    {
        ...
        else
        {
            ...
            {
                ScaledResolution scaledresolution = new ScaledResolution(this.mc, 0, 0);
    ...
    public void setLoadingProgress(int progress)
    {
        ...
        else
        {
            ...
            {
                this.systemTime = i;
                ScaledResolution scaledresolution = new ScaledResolution(this.mc, progress, progress);
