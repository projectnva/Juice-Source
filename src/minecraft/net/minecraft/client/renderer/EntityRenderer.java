...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    public void func_181560_a(float p_181560_1_, long p_181560_2_)
    {
        ...
        if (!this.mc.skipRenderWorld)
        {
            ...
            final ScaledResolution scaledresolution = new ScaledResolution(this.mc, debugViewDirection, debugViewDirection);
    ...
    {
        this.setupOverlayRendering();
        this.mc.ingameGUI.renderStreamIndicator(new ScaledResolution(this.mc, debugViewDirection, debugViewDirection));
    }
    ...
    {
        ScaledResolution scaledresolution = new ScaledResolution(this.mc, debugViewDirection, debugViewDirection);
        GlStateManager.clear(256);
        GlStateManager.matrixMode(5889);
        GlStateManager.loadIdentity();
