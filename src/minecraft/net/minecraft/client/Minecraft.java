...
import clientname.mods.impl.togglesprintsneak.JuiceMovementInput;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        SplashProgress.setProgress(2, "Minecraft - ModdleManager");
        this.modelManager = new ModelManager(this.textureMapBlocks);
        this.mcResourceManager.registerReloadListener(this.modelManager);
        this.renderItem = new RenderItem(this.renderEngine, this.modelManager);
        SplashProgress.setProgress(3, "Minecraft - RenderItem");
        this.renderManager = new RenderManager(this.renderEngine, this.renderItem);
        SplashProgress.setProgress(4, "Minecraft - ModdleManager");
    ...
    {
        ScaledResolution scaledresolution = new ScaledResolution(this, displayHeight, displayHeight);
    ...
    private void resize(int width, int height)
    {
        ...
        if (this.currentScreen != null)
        {
            ScaledResolution scaledresolution = new ScaledResolution(this, height, height);
    ...
    public void loadWorld(WorldClient worldClientIn, String loadingMessage)
    {
        ...
        if (worldClientIn != null)
        {
            ...
            this.thePlayer.movementInput = new JuiceMovementInput(this.gameSettings);
	...
	public EntityPlayer func_175606_aa() {
